...
void QgsAttributeTypeDialog::updateReuseLastValuePolicyLabel()
{
  ...
  switch ( mReuseLastValuePolicyComboBox->currentData().value<Qgis::AttributeFormReuseLastValuePolicy>() )
  {
    ...
    case Qgis::AttributeFormReuseLastValuePolicy::AllowedDefaultOn:
      helperText = tr( "The last entered value will be reused by default. A pin button is added to toggle the behavior across feature addition. When active, the last entered value will take priority over the default value." );
      break;

    case Qgis::AttributeFormReuseLastValuePolicy::AllowedDefaultOff:
      helperText = tr( "The last entered value can be reused but will not be by default. A pin toggle is added to toggle the behavior across feature addition. When active, the last entered value will take priority over the default value." );
      break;
  }
